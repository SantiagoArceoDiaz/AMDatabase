...
#final_reduct = quick_reduct(mushroom.columns[1:], [mushroom.columns[0]], mushroom)
        ...
        # Definir el índice inicial del conjunto a mostrar
        current_index = 0

        # Crear el slider para seleccionar el conjunto
        selected_index = st.slider('Selecciona el conjunto:', 0, len(conjuntos)-1, current_index)
